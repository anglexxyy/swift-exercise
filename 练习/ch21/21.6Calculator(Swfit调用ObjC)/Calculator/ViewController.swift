...
class ViewController: UIViewController {
    ...
    @IBAction func operandPressed(sender: AnyObject) {
        ...
        mainLabel.text =  logic.calculateByTag(CInt(btn.tag), withMainLabelString: mainLabel.text)
    }
    ...
    @IBAction func numberButtonPressed(sender: AnyObject) {
        ...
        var btn : UIButton = sender as UIButton
        mainLabel.text =  logic.updateMainLabelStringByNumberTag(CInt(btn.tag), withMainLabelString: mainLabel.text)
